...
const Footer = ({ onAutomate, isAutomating, isSoundEnabled, onSoundToggle }) => {
  ...
  const isPlayBingoPage = location.pathname === '/play-bingo' || location.pathname === '/baby-shower-bingo';
  const showSoundToggle = location.pathname === '/play-bingo';
    ...
    <footer style={{ position: 'relative' }}>
        ...
        <Container>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', minHeight: '3rem' }}>
                <p style={{ margin: 0, textAlign: 'center' }}>&copy; Bingo 2026. Enjoy Responsibly! </p>
                {isPlayBingoPage && (
